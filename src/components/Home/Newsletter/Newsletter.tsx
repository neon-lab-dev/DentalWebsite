  ...
  return (
    ...
    >
      <div className="flex flex-col gap-8 z-10"> {/* Add z-index for content */}
        ...
        <p className="text-neutral-10 font-Poppins text-xl max-w-[500px] 2xl:max-w-[681px] text-xs lg:text-xl sm:text-base">
      ...
      <div className="relative w-full max-w-[458px] md:max-w-[500px] 2xl:max-w-[741px] z-10"> {/* Add z-index for form */}
        <input
          type="text"
          placeholder="Enter Email ID"
          className="w-full max-w-[318px]  sm:max-w-[528px] 2xl:max-w-[741px] focus:outline-none bg-white py-[36px] pr-[250px] pl-8 rounded-[61px]"
        />
        <button className="md:px-[50px] sm:px-8 px-6 py-4 w-fit h-[65px] flex items-center gap-3 bg-secondary-10 md:text-[22px] sm:text-base text-xs font-semibold rounded-[55px] absolute top-4 bottom-0 right-3">
          Submit
          <Image
